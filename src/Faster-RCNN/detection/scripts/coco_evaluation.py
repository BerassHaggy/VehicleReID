...
class COCOEvaluator(DatasetEvaluator):
    ...
    def _derive_coco_results(self, coco_eval, iou_type, class_names=None):
        ...
        for ar_metric, idx in ar_metrics_map.items():
            # Adding AR metrics to results, no multiplication by 100 for percentage representation
            results[ar_metric] = float(coco_eval.stats[idx] if coco_eval.stats[idx] >= 0 else "nan")
