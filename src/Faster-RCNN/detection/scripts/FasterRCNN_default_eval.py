...
dataset = "highway_vehicles"  # options: highway_vehicles, custom_dataset
...
cfg.SOLVER.MAX_ITER = int(
    total_iterations)  # 300 iterations seems good enough for this toy dataset; you will need to train longer for a practical dataset
cfg.SOLVER.MAX_ITER = 200
cfg.SOLVER.STEPS = []  # do not decay learning rate
cfg.MODEL.ROI_HEADS.BATCH_SIZE_PER_IMAGE = 128  # The "RoIHead batch size". 128 is faster, and good enough for this toy dataset (default: 512)
if dataset.startswith("custom"): # (5 for custom dataset, 12 for highway vehicles)
    cfg.MODEL.ROI_HEADS.NUM_CLASSES = 5
elif dataset.startswith("highway"):
    cfg.MODEL.ROI_HEADS.NUM_CLASSES = 12
cfg.MODEL.WEIGHTS = "/storage/plzen1/home/krausm00/DP/FastRCNN/models/" + dataset + "/first_train/best_model.pth"  # Tuned models weights for the final evaluation
...
wandb.init(project="HIGHWAY_VEHICLES", entity="krausm00", config=cfg, name="FasterRCNN_best_params")
